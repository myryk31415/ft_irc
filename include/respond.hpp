...
// Replies
# define RPL_CHANGEDMODE(nick, host, channel, modes, args) (":" + nick + "!" + host + "@localhost MODE " + (channel[0] == '#' ? "" : "#") + channel + " " + modes + " " + args + CRLF)
# define RPL_CHANNELMODEIS(nick, channel, modes, mode_values) (":324 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " " + modes + " " + mode_values + CRLF)
# define RPL_NOTOPIC(nick, channel) (":331 " + nick + " " +  channel + " :No topic is set"+ CRLF)
# define RPL_TOPIC(nick, channel, topic) (":332 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :" + topic + CRLF)
# define RPL_TOPICWHOTIME(nick, channel, senderTime) (":333 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " " + senderTime + CRLF)
# define RPL_INVITING(nick, user_nick, channel) (":341 "+ nick + " " + user_nick + " " + (channel[0] == '#' ? "" : "#") + channel + CRLF)
# define RPL_NAMREPLY(nick, channel, allUsers) (":353 " + nick + " = " + (channel[0] == '#' ? "" : "#") + channel + " :" + allUsers + CRLF)
# define RPL_ENDOFNAMES(nick, channel) (":366 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " " + ":End of /NAMES list" + CRLF)

// Errors
# define ERR_NOSUCHNICK(nick, user_nick) (":401 " + nick + " " + user_nick + " :No such nick/channel" + CRLF)
# define ERR_NOSUCHCHANNEL(nick, channel) (":403 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :No such channel" + CRLF)
...
# define ERR_USERNOTINCHANNEL(nick, user_nick, channel) (":441 " + nick + " " + user_nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :They aren't on that channel" + CRLF)
# define ERR_NOTONCHANNEL(nick, channel) (":442 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :You're not on that channel" + CRLF)
# define ERR_USERONCHANNEL(nick, user_nick, channel) (":443 " + nick + " " + user_nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :is already on channel" + CRLF)
...
# define ERR_CHANNELISFULL(nick, channel) (":471 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :Cannot join channel (+l)" + CRLF)
# define ERR_INVITEONLYCHAN(nick, channel) (":473 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :Cannot join channel (+i)" + CRLF)
# define ERR_BADCHANNELKEY(nick, channel) (":475 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :Cannot join channel (+k)" + CRLF)
# define ERR_CHANOPRIVSNEEDED(nick, channel) (":482 " + nick + " " + (channel[0] == '#' ? "" : "#") + channel + " :You're not channel operator" + CRLF)
